 ...
 * Theuser
 *
 * @ORM\Table(name="theuser", uniqueConstraints={@ORM\UniqueConstraint(name="theuseruniqid_UNIQUE", columns={"theuseruniqid"}), @ORM\UniqueConstraint(name="theuserlogin_UNIQUE", columns={"theuserlogin"}), @ORM\UniqueConstraint(name="theusermail_UNIQUE", columns={"theusermail"})}, indexes={@ORM\Index(name="fk_theuser_permission_idx", columns={"permission_idpermission"})})
 * @ORM\Entity
 */
class Theuser
{
