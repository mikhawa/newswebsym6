...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : jeu. 09 juin 2022 à 09:22
...
--
-- Base de données : `newswebsym`
--
DROP DATABASE IF EXISTS `newswebsym`;
CREATE DATABASE IF NOT EXISTS `newswebsym` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `newswebsym`;
...
CREATE TABLE IF NOT EXISTS `thearticle` (
  ...
  `thearticleactivate` tinyint(1) DEFAULT NULL COMMENT '0 => waiting\n1 => publish\n2 => deleted',
...
CREATE TABLE IF NOT EXISTS `thearticle_has_thecomment` (
  ...
  KEY `IDX_55B159BF8CC78EF2` (`thearticle_idthearticle`)
...
ALTER TABLE `thearticle`
  ADD CONSTRAINT `FK_FCCE11EF770E00F5` FOREIGN KEY (`theuser_idtheuser`) REFERENCES `theuser` (`idtheuser`);

--
-- Contraintes pour la table `thearticle_has_thecomment`
--
ALTER TABLE `thearticle_has_thecomment`
  ADD CONSTRAINT `FK_55B159BF512C6914` FOREIGN KEY (`thecomment_idthecomment`) REFERENCES `thecomment` (`idthecomment`),
  ADD CONSTRAINT `FK_55B159BF8CC78EF2` FOREIGN KEY (`thearticle_idthearticle`) REFERENCES `thearticle` (`idthearticle`);
